		...
		<div class="container">
			<form name="newMember" class="form-horizontal"  action="processUpdateMember.jsp" method="post" onsubmit="return checkForm()">
				<div class="form-group  row">
					...
					<div class="col-sm-3">
						<span class="form-control"><c:out value='${row.id}'/></span>
					</div>
				</div>
				<div class="form-group  row">
				...
				<div class="form-group  row">
					...
					<div class="col-sm-3">
						<input name="password_confirm" type="password" class="form-control" placeholder="password confirm" value="<c:out value='${row.password}'/>">
					</div>
				</div>
				<div class="form-group  row">
